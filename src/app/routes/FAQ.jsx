...
/**
 * Two topics, two full-width stripes, left-aligned.
 *
 * The previous version put everything in one centred white box: long answers
 * were centre-aligned, which makes every line start in a different place, and
 * the box ran well past the banner image into a white void. The structure
 * here is the same one Lesson Info uses — alternating stripes — and the class
 * names are chosen so this page can be driven from the Google Doc later
 * without any of the design moving.
 */
export default function FAQ() {
    return (
        <>
            ...
            <section className='white-stripe qa'>
                <h2>Registration</h2>

                <h3>Is there an age limit for lessons?</h3>
                <p>We accept students as young as 5 years old.</p>

                <h3>I filled out the registration form, but can&rsquo;t figure out where to pay.</h3>
                ...
                <h3>Why aren&rsquo;t lift tickets included in lesson fees?</h3>
                ...
                <p><a target='_blank' rel='noopener noreferrer' href='http://www.summitatsnoqualmie.com/tickets-and-passes/daily-lift-tickets'>Daily lift tickets at The Summit at Snoqualmie</a></p>

                <h3>How do refunds work?</h3>
                <p>See the <Link to='/lesson-registration'>Lesson Registration</Link> page for details.</p>
            </section>

            <section className='purple-stripe qa'>
                <h2>Lessons</h2>

                <h3>Why isn&rsquo;t my child on the lift yet?</h3>
                <ul>
                ...
                <p>Enjoy the 1,994 acres and lifts that Snoqualmie has to offer, grab a coffee or snack in the lodge, or take an adult lesson with us! While we know you want to see your children&rsquo;s progress first hand, it is easier for the instructors to teach when they have their students&rsquo; full attention.</p>
                ...
                <h3>Why isn&rsquo;t my child in the same lesson as their friends?</h3>
                ...
                <p>All of our instructors are unpaid volunteers who spend hours training to teach the sports that they love &mdash; tips are not required, but greatly appreciated.</p>
