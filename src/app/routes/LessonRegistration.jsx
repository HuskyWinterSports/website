    ...
    return (
        <>
            ...
            <section className='white-stripe'>
                ...
                <ol>
                    <li>Injury Before Lessons Start (within one month): If the injury occurs within one month before the lessons begin, we will issue an 80% refund. This refund will require valid documentation.</li>
                ...
                {/* Named the role, not the person. The previous director's
                    name was still published here after they left the role, in
                    three places. Officers turn over every year, so a name in
                    body text is a fact with an expiry date and nobody whose
                    job it is to notice. It becomes a Sheet value in phase 2. */}
                <p>We strive to provide flexibility and fairness in our refund policies, but it's essential to adhere to the specific guidelines mentioned above for refund eligibility and exceptions. For any further clarification or assistance, please feel free to contact our lesson director.</p>
                ...
                <p>At our discretion, we may consider exceptions to our standard refund policies in certain circumstances. While we strive to maintain consistency in our policies for all customers, we understand that unique situations may arise. If you believe you have valid grounds for a refund or require special consideration due to extenuating circumstances, we encourage you to reach out to our lesson director at <a href='mailto:huskywslessons@gmail.com'>huskywslessons@gmail.com</a>. Our team will carefully review your request and, where appropriate, exercise our discretion to assess the situation on a case-by-case basis. Please understand that granting an exception is not guaranteed and will be subject to our sole judgment. We are committed to ensuring customer satisfaction and will make every effort to address your concerns in a fair and equitable manner.</p>
